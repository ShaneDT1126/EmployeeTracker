...
namespace EmployeeManagementSystem.Application.Interfaces.Services
{
    public interface IUserService
    {
        ...
        public Task<DTOs.User.UserViewDTO> CreateUserAsync(DTOs.User.UserUpdateDTO user, Guid requesterId, UserRole requestingRole);
        public Task<DTOs.User.UserViewDTO?> UpdateUserAsync(Guid id, DTOs.User.UserUpdateDTO user, Guid requesterId, UserRole requestingRole);
